...
// Sat Jul 20 13:24:25 2024 by ROOT version 6.32.02
// from TTree TreeLRC/
// found on file: AnalysisResults_PPSS2024.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("AnalysisResults_PPSS2024.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("AnalysisResults_PPSS2024.root");
      }
      f->GetObject("TreeLRC",tree);
