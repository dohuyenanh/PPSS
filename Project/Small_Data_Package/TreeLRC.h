...
// Mon Jul 15 11:54:38 2024 by ROOT version 6.32.02
// from TTree TreeLRC/
// found on file: tAnalysisResults_265521.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Float_t         Centrality_CL0;
   Float_t         Centrality_CL1;
   Float_t         Centrality_V0Mplus05;
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("tAnalysisResults_265521.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("tAnalysisResults_265521.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("tAnalysisResults_265521.root:/fb_768");
...
void TreeLRC::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("N", N, &b_n_1);
   fChain->SetBranchAddress("NPt", NPt, &b_n_2);
